            ...
            ">
                <div className="grid md:grid-cols-5  gap-x-5 items-center lg:mx-20">
                    ...
                    <div className="max-w-md">
                        ...
                        <TextInput id="input-gray" placeholder="Which Place?" required color="gray" />
                    </div>
                    <div className="max-w-md">
                        <div className="mb-2 ">
                            <Label htmlFor="input-gray" color="gray" value="Price" />
                        </div>
                        <TextInput id="input-gray" placeholder="$ Price" required color="gray" className=" border-rose-500 pr-5 border-dotted border-r-2"
                        />
                    </div>
                    
                    <div className="gap-x-2 flex items-center
                     bg-rose-500 p-3 mt-5 
