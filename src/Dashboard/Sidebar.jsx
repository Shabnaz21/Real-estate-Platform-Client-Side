    ...
    return (
        ...
        <div className="body-content" x-data="{ open: true }">
            <div className="relative lg:block navbar-menu">
                <nav x-bind:className="! open ? 'w-0' : 'w-[280px]'"
                    ...
                    <div className="flex items-center w-full px-4 pt-4 pb-4 border-b border-gray-600 dark:border-gray-700">
                        <a href="#">
                            <h2 className="ml-3 text-lg font-bold text-white whitespace-nowrap"> Your Logo </h2>
                        </a>
                    </div>
                            ...
                            <li x-data="{ open: false }">
                                ...
                                <div className="pl-3 ml-3 transition border-gray-500 dropdown-section nested-menu"
                                    ...
                                    <ul className="text-sm font-medium">
                                        <li>
                                            <a href="#"
                                                className="flex items-center py-3 pl-3 pr-4 text-white rounded dark:text-gray-400 dark:hover:bg-gray-800 hover:bg-gray-900 ">
            ...
            <div className="mx-auto transition-all content-wrapper" id="dash"
                ...
                <section className="sticky top-0 z-40 px-3 py-3 bg-white shadow dark:bg-gray-900 lg:px-5">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="relative text-left lg:inline-block" x-data="{ open: false }">
                                    <div className="lg:block" @click="open = ! open">
                                    ...
                                    <div x-show="open" id="dropdown_profile"
                                        className="absolute right-0 w-48 mt-3 origin-top-right bg-white rounded shadow dark:bg-gray-700"
                                        style="display: none;">
                                        <div className="py-1">
                                            <a href="#"
                ...
                <div className="p-4 lg:p-8">
                    <div className="">
                        <div className="mx-auto">
                            <h1 className="mb-5 text-2xl font-bold text-black dark:text-gray-400"> Dashboard </h1>
                            <div className="grid grid-cols-1 gap-4 lg:gap-8 lg:grid-cols-3">
                                <div className="p-6 mb-6 bg-white rounded shadow card dark:bg-gray-900">
                                    <h2 className="mb-6 text-xl font-semibold dark:text-gray-400"> Authors </h2>
                                    <div className="flex items-center mb-4">
                                        <img className="object-cover mr-4 rounded-md w-14 h-14"
                                            src="https://i.postimg.cc/kDPCCqWP/pexels-emmy-e-2381069.jpg" alt="">
                                        <div>
                                            <p className="font-bold dark:text-gray-400">Richa Smith</p>
                                            <p className="text-sm text-gray-400"> Assistant Manager </p>
                                        </div>
                                    </div>
                                    <div className="flex items-center mb-4">
                                        <img className="object-cover mr-4 rounded-md w-14 h-14"
                                            ...
                                            alt="">
                                        <div>
                                            <p className="font-bold dark:text-gray-400">Navreen Doe</p>
                                            <p className="text-sm text-gray-400"> Front End Developer </p>
                                        </div>
                                    </div>
                                    <div className="flex items-center">
                                        <img className="object-cover mr-4 rounded-md w-14 h-14"
                                            src="https://i.postimg.cc/nL2h1jBj/pexels-anastasia-shuraeva-5704720.jpg"
                                            alt="">
                                        <div>
                                            <p className="font-bold dark:text-gray-400">Deep RK</p>
                                ...
                                <div className="p-6 mb-6 bg-white rounded shadow card dark:bg-gray-900">
                                    ...
                                    <div className="flex items-center mb-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" className="w-8 h-8 mr-4 text-blue-500" viewBox="0 0 16 16">
                                            <path
                                        ...
                                        <div>
                                            <p className="font-semibold dark:text-gray-400"> New Product has been purchased
                                                successfully</p>
                                    ...
                                    <div className="flex items-center mb-4">
                                        ...
                                        <div>
                                            <p className="font-semibold dark:text-gray-400"> Product has been returned
                                                successfully</p>
                                    ...
                                    <div className="flex items-center mb-4">
                                        ...
                                        <div>
                                            <p className="font-semibold dark:text-gray-400"> New Shipment has arrived. View
                                                Now
                                            </p>
                                            <p className="text-sm text-gray-400"> 23 hours ago</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="p-6 mb-6 bg-white rounded shadow card dark:bg-gray-900">
                                    <h2 className="mb-6 text-xl font-semibold dark:text-gray-400"> Todo </h2>
                                    <div className="flex items-center mb-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" className="w-8 h-8 mr-4 text-blue-500" viewBox="0 0 16 16">
                                            <path
                                        ...
                                        <div>
                                            <p className="font-semibold dark:text-gray-400"> Going out tonight changes into
                                                something red</p>
                                            <p className="text-sm text-gray-400"> Due 23 days ago </p>
                                        </div>
                                    </div>
                                    <div className="flex items-center mb-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <div>
                                            <p className="font-semibold dark:text-gray-400"> Going out for shopping </p>
                                            <p className="text-sm text-gray-400"> 5 hours ago </p>
                                        </div>
                                    </div>
                                    <div className="flex items-center mb-4">
                                        ...
                                        <div>
                                            <p className="font-semibold dark:text-gray-400"> Eating only healthy foods
                                            </p>
                                            <p className="text-sm text-gray-400"> 23 hours ago</p>
                                        </div>
                                    </div>
